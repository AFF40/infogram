package com.sotec.infobook.view.fragment;
...
import com.sotec.infobook.adapter.CardViewAdapter;
import com.sotec.infobook.model.Image;
...
public class ProfileFragment extends Fragment {
    ...
    public ArrayList<Image> buidImages() {
        ...
        images.add(new Image("https://laicismo.org/wp-content/uploads/2017/02/Monumento-Virgen-de-Socavon-en-Oruro-Bolivia.jpg", "Luis Peres", "3 dias", "5 me gusta"));
        images.add(new Image("https://serturista.com/wp-content/uploads/2014/01/Castillo-de-la-Glorieta-2.jpg", "Fernando Torricos", "6 dias", "4 me gusta"));
        ...
        images.add(new Image("https://www.wamanadventures.com/blog/wp-content/uploads/2019/06/La-Laguna-Colorada-Waman-Adventures.jpg", "Rolando Morales", "3 dias", "2 me gusta"));
        ...
        images.add(new Image("https://www.lostiempos.com/sites/default/files/styles/noticia_detalle/public/media_imagen/2018/1/13/1-_roma_2-_hector_arnez.jpg?itok=E9jbs43e", "Lorena Herrera", "2 dias", "8 me gusta"));
        ...
        images.add(new Image("https://i1.wp.com/elcalderoviajero.com/wp-content/uploads/2018/04/bolivia-cochabamba-incachaca-15.jpg?resize=750%2C563&ssl=1", "Marcelo Rojas", "9 dias", "1 me gusta"));
